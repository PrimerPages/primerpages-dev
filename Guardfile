...
def build_all
  system("bin/local_build.sh --source site --destination _site -- --incremental")
  system("bin/local_build.sh --source templates/primerpages-minimal --baseurl /primerpages-minimal --destination _site/primerpages-minimal -- --incremental")
  system("bin/local_build.sh --source templates/primerpages-recommended --baseurl /primerpages-recommended --destination _site/primerpages-recommended -- --incremental")
  system("bin/local_build.sh --source templates/primerpages-gh-pages --baseurl /primerpages-gh-pages --destination _site/primerpages-gh-pages -- --incremental")
end
