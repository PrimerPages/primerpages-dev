...
assert_versioned_docs() {
  ...
  run grep -FR "data-versions-json=\"/dev/versions.json\"" "$page"
  assert_success "Docs page did not expose the baseurl-aware versions JSON URL"
  run grep -FR "data-versions-json=\"/1.2.3/versions.json\"" "$release_page"
  assert_success "Release docs page did not expose the baseurl-aware versions JSON URL"
  ...
  run test -f "_site/dev/versions.json"
  assert_success "dev versions.json was not copied into the built site"
  run test -f "_site/1.2.3/versions.json"
  assert_success "release versions.json was not copied into the built site"
